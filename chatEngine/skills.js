...
const SERVER_URL = require('../config/default.json')['FB']['serverURL'];
const PAGE_ACCESS_TOKEN = require('../config/default.json')['FB']['pageAccessToken'];
...
function sendTextMessage(recipientId, messageText) {
  ...
  console.log(`recipientId: ${recipientId}, message: ${messageText}\n\n`);
  var messageData = {
    recipient: {
      id: recipientId
    },
...
function sendTextMessage(recipientId, messageText) {
  console.log('[sendTextMessage()]: message: ' + messageText);
  console.log('[sendTextMessage()]: recipientId: ' + recipientId)
  var messageData = {
    recipient: {
      id: recipientId
    },
